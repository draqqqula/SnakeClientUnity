...
public class PartyStatusUIController : MonoBehaviour
{
    private readonly Dictionary<Guid, PlayerIconUIController> _players = new ();

    [field: SerializeField] private RectTransform Area { get; set; }
    [field: SerializeField] private PlayerIconUIController IconBase { get; set; }
    [field: SerializeField] private float HorizontalSpacing { get; set; }
    [field: SerializeField] private float VerticalSpacing { get; set; }
    private PlayerIconUIController Leader {  get; set; }
    private PlayerIconUIController ActualPlayer { get; set; }
